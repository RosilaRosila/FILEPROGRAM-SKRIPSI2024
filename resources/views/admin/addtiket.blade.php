                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0 text-dark" style="font-weight: bold;">Tambah Data Tiket</h5>
                            </div>
                            <div class="card-body">
                                <br>
                                <form action="{{ route('admin.admin_datatiket_store') }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="txtnama" class="form-label" style=" font-weight:normal">Masukan Nama Tempat Wisata</label>
                                        <input type="text" name="namawst" id="txtnama" class="form-control" value="{{ old('namawst') }}">
                                    </div>
                                    <div class="mt-5">
                                        <label for="txtharga" class="form-label" style=" font-weight:normal">Masukan Harga Tiket</label>
                                        <input type="text" class="form-control" id="txtname" name="harga" value=" {{ old('harga') }}">
                                    </div>
                                    <br>
                                    <br>
                                    <a class="btn btn-warning " href="http://127.0.0.1:8000/admin/data-tiket" style="color: white;">
                                        Kembali
                                    </a>
